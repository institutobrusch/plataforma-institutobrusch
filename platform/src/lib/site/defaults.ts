...
export const DEFAULTS: SecaoMap = {
  ...
  home: {
    ...
    sobreFotoPath: "", sobreEyebrow: "Sobre",
    sobreTitulo: "Um cuidado com profundidade e método",
    sobreTexto: "O Instituto Brusch une o rigor da psicologia clínica ao trabalho de autoconhecimento em grupo — para quem quer romper padrões e viver com mais presença.",
    sobreCta1Label: "Conhecer o Instituto", sobreCta1Href: "/instituto",
    sobreCta2Label: "Sobre a Camila", sobreCta2Href: "/camila",
    depoEyebrow: "Histórias", depoTitulo: "O que dizem quem passou por aqui",
    ctaFinalEyebrow: "Cartografia",
    ctaFinalTitulo: "A sua Cartografia começa com um encontro",
    ctaFinalTexto: "Um acompanhamento contínuo a partir da sua carta — leituras mensais, áudios e materiais que caminham com você.",
    ctaFinalLabel: "Conhecer a Cartografia", ctaFinalHref: "/cartografia",
